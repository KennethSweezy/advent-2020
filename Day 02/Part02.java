	...
	public static void main(String[] args) {
		...
		try {
			...
			for(int i = 0; i < lines.size(); i++) {
				...
				char allChar = allowedChar.charAt(0);
				if(arr[2].charAt(allowedNum[0] - 1) == allChar ? (arr[2].charAt(allowedNum[1] - 1) == allChar ? false : true) : arr[2].charAt(allowedNum[1] - 1) == allChar) {
					validPasses++;
